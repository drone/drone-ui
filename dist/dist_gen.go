...
var files = map[string]file{
	"/favicon.png": {
		...
		FileInfo: &fileInfo{
			name:    "favicon.png",
			size:    1374,
			modTime: time.Unix(1505089147, 0),
		},
	},
	"/index.html": {
		data: file1,
	...
	"/static/bundle.db478d21eaff85695bb2.js": {
		data: file2,
		FileInfo: &fileInfo{
			name:    "bundle.db478d21eaff85695bb2.js",
			size:    343277,
			modTime: time.Unix(1505089147, 0),
		},
	},
	"/static/vendor.c6df90ef362bcb7f8fa3.js": {
		data: file3,
		FileInfo: &fileInfo{
			name:    "vendor.c6df90ef362bcb7f8fa3.js",
			size:    272208,
			modTime: time.Unix(1505089147, 0),
		},
	},
...
<body>
<script type="text/javascript" src="/static/vendor.c6df90ef362bcb7f8fa3.js"></script><script type="text/javascript" src="/static/bundle.db478d21eaff85695bb2.js"></script></body>
</html>
`)
...
var _refresh = __webpack_require__(463);
...
var _reactTimeago = __webpack_require__(128);
...
var RedirectRoot = (_dec = (0, _higherOrder.branch)(binding), _dec(_class = function (_Component) {
	...
	RedirectRoot.prototype.render = function render() {
		...
		return !loaded ? undefined : !user ? undefined : !latest ? _react2["default"].createElement(_reactRouterDom.Redirect, { to: "/account/repos" }) : !latest.number ? _react2["default"].createElement(_reactRouterDom.Redirect, { to: "/" + latest.full_name }) : _react2["default"].createElement(_reactRouterDom.Redirect, { to: "/" + latest.full_name + "/" + latest.number });
	};
...
var _anchor = __webpack_require__(539);
...
var _drone = __webpack_require__(581);
...
var _menu3 = __webpack_require__(533);

var _menu4 = _interopRequireDefault(_menu3);

var _menu5 = __webpack_require__(534);
...
var _anchor = __webpack_require__(196);
