...
var files = map[string]file{
	"/favicon.png": {
		...
		FileInfo: &fileInfo{
			name:    "favicon.png",
			size:    1374,
			modTime: time.Unix(1537129647, 0),
		},
	},
	"/index.html": {
		data: file1,
	...
	"/static/bundle.a753c4ecd23cd568a00f.js": {
		data: file2,
		FileInfo: &fileInfo{
			name:    "bundle.a753c4ecd23cd568a00f.js",
			size:    304424,
			modTime: time.Unix(1537129647, 0),
		},
	},
	"/static/vendor.8b3dc28d38d99dff1b8c.js": {
		data: file3,
		FileInfo: &fileInfo{
			name:    "vendor.8b3dc28d38d99dff1b8c.js",
			size:    271960,
			modTime: time.Unix(1537129647, 0),
		},
	},
...
<body>
<script type="text/javascript" src="/static/vendor.8b3dc28d38d99dff1b8c.js"></script><script type="text/javascript" src="/static/bundle.a753c4ecd23cd568a00f.js"></script></body>
</html>
`)
...
var	fixUrls = __webpack_require__(414);
 ...
 */
var fetchRepository = exports.fetchRepository = function fetchRepository(tree, client, namespace, name) {
	tree.unset(["repo", "error"]);
	tree.unset(["repo", "loaded"]);

	client.getRepo(namespace, name).then(function (repo) {
...
var syncRepostoryList = exports.syncRepostoryList = function syncRepostoryList(tree, client) {
	...
	client.synchronize().then(function (results) {
		var list = {};
		results.map(function (repo) {
			list[repo.slug] = repo;
		});
 ...
 */
var updateRepository = exports.updateRepository = function updateRepository(tree, client, namespace, name, data) {
	client.updateRepo(namespace, name, data).then(function (repo) {
		tree.set(["repos", "data", repo.slug], repo);
 ...
 * @param {string} name - The repository name.
 */
var enableRepository = exports.enableRepository = function enableRepository(tree, client, namespace, name) {
	client.activateRepo(namespace, name).then(function (result) {
 ...
 * @param {string} name - The repository name.
 */
var disableRepository = exports.disableRepository = function disableRepository(tree, client, namespace, name) {
	client.deleteRepo(namespace, name).then(function (result) {
 ...
 * @param {string} name - The repository name.
 */
var repositorySlug = exports.repositorySlug = function repositorySlug(namespace, name) {
...
var _back = __webpack_require__(450);

var _back2 = _interopRequireDefault(_back);

var _branch = __webpack_require__(451);

var _branch2 = _interopRequireDefault(_branch);

var _check = __webpack_require__(452);

var _check2 = _interopRequireDefault(_check);

var _clock = __webpack_require__(453);
...
var _commit = __webpack_require__(454);

var _commit2 = _interopRequireDefault(_commit);

var _deploy = __webpack_require__(455);

var _deploy2 = _interopRequireDefault(_deploy);

var _expand = __webpack_require__(456);

var _expand2 = _interopRequireDefault(_expand);

var _launch = __webpack_require__(457);

var _launch2 = _interopRequireDefault(_launch);

var _link = __webpack_require__(458);
...
var _merge = __webpack_require__(459);

var _merge2 = _interopRequireDefault(_merge);

var _pause = __webpack_require__(460);
...
var _remove = __webpack_require__(462);

var _remove2 = _interopRequireDefault(_remove);

var _schedule = __webpack_require__(463);

var _schedule2 = _interopRequireDefault(_schedule);

var _sync = __webpack_require__(464);

var _sync2 = _interopRequireDefault(_sync);

var _tag = __webpack_require__(465);

var _tag2 = _interopRequireDefault(_tag);

var _timelapse = __webpack_require__(466);
...
var _status2 = __webpack_require__(448);
...
var STATUS_WAITING = "waiting_on_dependencies";
...
exports.STATUS_PLANNED = STATUS_PLANNED;
...
var _duration = __webpack_require__(469);

var _duration2 = _interopRequireDefault(_duration);

var _build_time = __webpack_require__(470);
...
var _repository = __webpack_require__(39);
 ...
 */
var fetchBuild = exports.fetchBuild = function fetchBuild(tree, client, namespace, name, number) {
	var slug = (0, _repository.repositorySlug)(namespace, name);

	tree.unset(["builds", "loaded"]);
	client.getBuild(namespace, name, number).then(function (build) {
 ...
 * @param {string} name - The repository name.
 */
var fetchBuildList = exports.fetchBuildList = function fetchBuildList(tree, client, namespace, name) {
	...
	client.getBuildList(namespace, name, { page: page }).then(function (results) {
		var list = {};
 ...
 */
var cancelBuild = exports.cancelBuild = function cancelBuild(tree, client, namespace, repo, build) {
	client.cancelBuild(namespace, repo, build).then(function (result) {
 ...
 * @param {number} build - The build number.
 */
var restartBuild = exports.restartBuild = function restartBuild(tree, client, namespace, repo, build) {
	client.restartBuild(namespace, repo, build, { fork: true }).then(function (result) {
 ...
 * @param {number} build - The build number.
 */
var approveBuild = exports.approveBuild = function approveBuild(tree, client, namespace, repo, build) {
	client.approveBuild(namespace, repo, build).then(function (result) {
 ...
 * @param {number} build - The build number.
 */
var declineBuild = exports.declineBuild = function declineBuild(tree, client, namespace, repo, build) {
	client.declineBuild(namespace, repo, build).then(function (result) {
...
var _breadcrumb = __webpack_require__(500);
...
var fetchFeed = exports.fetchFeed = function fetchFeed(tree, client) {
	client.getRepoList({ latest: true }).then(function (results) {
		var list = {};
...
var _status_number = __webpack_require__(483);
...
var _build_event = __webpack_require__(486);
		...
		return _react2["default"].createElement(
			...
			_react2["default"].createElement(
				...
				_react2["default"].createElement(
					"div",
					null,
					event === _events.EVENT_TAG && refs ? trimTagRef(refs) : event === _events.EVENT_PULL_REQUEST && refspec ? trimMergeRef(refs) : event === _events.EVENT_DEPLOY && deployTo ? deployTo : target
				)
			),
			_react2["default"].createElement(
				"a",
...
exports.checkSyncing = checkSyncing;
...
var generateToken = exports.generateToken = function generateToken(tree, client) {
	client.getToken().then(function (result) {
...
function checkSyncing(tree, client) {
	var user = tree.get(["user", "data"]);
	if (!user.syncing) {
		return;
	}
	var timer = setInterval(function () {
		client.getSelf().then(function (result) {
			...
			clearInterval(timer);
			(0, _message.displayMessage)(tree, "Failed to fetch your account details");
		});
	}, 5000);
}
...
var _higherOrder = __webpack_require__(20);
...
var RedirectRoot = (_dec = (0, _higherOrder.branch)(binding), _dec(_class = function (_Component) {
	...
	RedirectRoot.prototype.componentWillMount = function componentWillMount() {
	...
	RedirectRoot.prototype.render = function render() {
		...
		var syncing = user && user.syncing;

		return syncing ? _react2["default"].createElement(_sync.Message, null) : !loaded ? undefined : !user ? undefined : !latest ? _react2["default"].createElement(_reactRouterDom.Redirect, { to: "/account/repos" }) : !latest.number ? _react2["default"].createElement(_reactRouterDom.Redirect, { to: "/" + latest.slug }) : _react2["default"].createElement(_reactRouterDom.Redirect, { to: "/" + latest.slug + "/" + latest.number });
	};
...
var nameMenu = function (_Component) {
	_inherits(nameMenu, _Component);

	function nameMenu() {
		_classCallCheck(this, nameMenu);

		return _possibleConstructorReturn(this, _Component.apply(this, arguments));
	}

	nameMenu.prototype.render = function render() {
		var _props$match$params = this.props.match.params,
		    namespace = _props$match$params.namespace,
...
function init() {
	var App = __webpack_require__(405)["default"];
...
var _state = __webpack_require__(408);

var _state2 = _interopRequireDefault(_state);

var _client = __webpack_require__(409);

var _client2 = _interopRequireDefault(_client);

var _inject = __webpack_require__(28);

var _screens = __webpack_require__(410);

var _titles = __webpack_require__(422);
...
var _users = __webpack_require__(193);

var _reactRouterDom = __webpack_require__(29);

var _drone = __webpack_require__(558);
...
var _error = __webpack_require__(415);
...
var _report = __webpack_require__(419);
...
exports["default"] = function () {
	return _react2["default"].createElement(
		...
		_react2["default"].createElement(_reactRouterDom.Route, { path: "/:namespace/:name", exact: false, component: repoTitle }),
...
var repoTitle = function repoTitle(_ref) {
	...
	return _react2["default"].createElement(_reactTitleComponent2["default"], { render: match.params.namespace + "/" + match.params.name + " | drone" });
};
...
var _feed = __webpack_require__(444);

var _feed2 = _interopRequireDefault(_feed);

var _settings = __webpack_require__(476);

var _settings2 = _interopRequireDefault(_settings);

var _builds = __webpack_require__(480);

var _builds2 = _interopRequireDefault(_builds);

var _repos = __webpack_require__(492);

var _repos2 = _interopRequireDefault(_repos);

var _tokens = __webpack_require__(504);
...
var _menu3 = __webpack_require__(511);

var _menu4 = _interopRequireDefault(_menu3);

var _build = __webpack_require__(512);

var _build2 = _interopRequireDefault(_build);

var _menu5 = __webpack_require__(540);

var _menu6 = _interopRequireDefault(_menu5);

var _menu7 = __webpack_require__(196);

var _menu8 = _interopRequireDefault(_menu7);

var _snackbar = __webpack_require__(541);

var _drawer = __webpack_require__(553);

var _layout = __webpack_require__(556);
			...
			_react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(
						...
						_react2["default"].createElement(_reactRouterDom.Route, { path: "/:namespace/:name", component: _header2["default"] })
					),
					user && user.data ? _react2["default"].createElement(
						"div",
						{ className: _layout2["default"].avatar },
						_react2["default"].createElement("img", { src: user.data.avatar })
					) : undefined,
					user && user.data ? _react2["default"].createElement(
						"button",
...
var _logo = __webpack_require__(445);
...
var _build_time = __webpack_require__(87);
		...
		return _react2["default"].createElement(
			...
			_react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					item.build ? _react2["default"].createElement(_status2["default"], { status: item.build.status }) : _react2["default"].createElement("noscript", null)
				)
			),
			_react2["default"].createElement(
				"div",
...
exports.locals = {
	...
	"waiting_on_dependencies": "status__waiting_on_dependencies___19Ga2",
...
var _visibility = __webpack_require__(477);
...
var Settings = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
	...
	Settings.prototype.componentWillMount = function componentWillMount() {
		...
		if (!repo) {
			dispatch(_repository.fetchRepository, drone, match.params.namespace, match.params.name);
		}
	};
	...
	Settings.prototype.handleChange = function handleChange(prop, value) {
		...
		var data = {};
		data[prop] = value;
		dispatch(_repository.updateRepository, drone, repo.namespace, repo.name, data);
	};
...
var Main = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
	...
	Main.prototype.synchronize = function synchronize(props) {
		...
		dispatch(_build.fetchBuildList, drone, match.params.namespace, match.params.name);
	};
	...
	Main.prototype.fetchNextBuildPage = function fetchNextBuildPage(buildList) {
		...
		var page = Math.floor(buildList.length / 25) + 1;

		dispatch(_build.fetchBuildList, drone, match.params.namespace, match.params.name, page);
	};
	...
	Main.prototype.render = function render() {
		...
		function renderBuild(build) {
			return _react2["default"].createElement(
				_reactRouterDom.Link,
				{ to: "/" + repo.slug + "/" + build.number, key: build.number },
		...
		return _react2["default"].createElement(
			...
			list.length < repo.counter && _react2["default"].createElement(
				"button",
				{
...
var _status_number = __webpack_require__(191);
...
var _build_event = __webpack_require__(192);
...
exports.locals = {
	...
	"waiting_on_dependencies": "status_number__waiting_on_dependencies___1OQ6y",
...
var UserRepos = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
	...
	UserRepos.prototype.handleToggle = function handleToggle(repo, e) {
		...
		if (e.target.checked) {
			dispatch(_repository.enableRepository, drone, repo.namespace, repo.name);
		} else {
			dispatch(_repository.disableRepository, drone, repo.namespace, repo.name);
		}
	};
...
var _switch = __webpack_require__(495);
...
var Item = exports.Item = function (_Component) {
	...
	Item.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
		return this.props.namespace !== nextProps.namespace || this.props.name !== nextProps.name || this.props.active !== nextProps.active;
	};
...
var _switch = __webpack_require__(496);
	...
	Header.prototype.render = function render() {
		...
		return _react2["default"].createElement(
			...
			_react2["default"].createElement(_breadcrumb2["default"], {
				elements: [_react2["default"].createElement(
					_reactRouterDom.Link,
					{ to: "/" + namespace + "/" + name, key: namespace + "-" + name },
					namespace,
					" / ",
					name
				)]
...
var _components = __webpack_require__(513);

var _higherOrder = __webpack_require__(20);

var _inject = __webpack_require__(28);

var _logs = __webpack_require__(527);

var _logs2 = _interopRequireDefault(_logs);

var _index = __webpack_require__(538);
...
var BuildLogs = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
	...
	BuildLogs.prototype.handleApprove = function handleApprove() {
		...
		this.props.dispatch(_build.approveBuild, drone, repo.namespace, repo.name, build.number);
	};
	...
	BuildLogs.prototype.handleDecline = function handleDecline() {
		...
		this.props.dispatch(_build.declineBuild, drone, repo.namespace, repo.name, build.number);
	};
	...
	BuildLogs.prototype.synchronize = function synchronize(props) {
		if (!props.repo) {
			this.props.dispatch(_repository.fetchRepository, props.drone, props.match.params.namespace, props.match.params.name);
		}
		if (!props.build || !props.build.stages) {
			this.props.dispatch(_build.fetchBuild, props.drone, props.match.params.namespace, props.match.params.name, props.match.params.build);
		}
	};
	...
	BuildLogs.prototype.render = function render() {
		...
		if (build.status === _status.STATUS_DECLINED) {
			return this.renderError();
		}

		if (build.status === _status.STATUS_ERROR && !build.stages) {
			return this.renderError();
		}
	...
	BuildLogs.prototype.renderSimple = function renderSimple() {
		...
		var parent = build && build.stages && build.stages[parseInt(match.params.stage) - 1 || 0];
		var step = parent && parent.steps && parent.steps[parseInt(match.params.step) - 1 || 0];
			...
			_react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(
						...
						null,
						build.stages.map(function (child) {
							return _react2["default"].createElement(
								_reactRouterDom.Link,
								{
...
var BuildLogsTitle = exports.BuildLogsTitle = function (_Component2) {
	...
	BuildLogsTitle.prototype.render = function render() {
		var _props$match$params2 = this.props.match.params,
		    namespace = _props$match$params2.namespace,
		    name = _props$match$params2.name,
...
var _approval = __webpack_require__(514);

var _details = __webpack_require__(517);

var _matrix = __webpack_require__(520);

var _procs = __webpack_require__(523);
...
var _approval = __webpack_require__(515);
...
var _matrix = __webpack_require__(521);
...
var _elapsed = __webpack_require__(524);

var _procs = __webpack_require__(525);
...
var ProcListItem = exports.ProcListItem = function ProcListItem(_ref2) {
	...
	return _react2["default"].createElement(
		...
		stopped ? _react2["default"].createElement(
			"time",
			null,
			(0, _elapsed.formatTime)(stopped, started)
		) : _react2["default"].createElement(_elapsed.Elapsed, { start: started }),
		_react2["default"].createElement(
			"div",
			null,
			_react2["default"].createElement(_status2["default"], { status: status })
...
var _proc = __webpack_require__(528);

var _logs = __webpack_require__(529);

var _term = __webpack_require__(530);
...
var _index2 = __webpack_require__(536);
...
var binding = function binding(props, context) {
	...
	var slug = (0, _repository.repositorySlug)(namespace, name);
	var number = parseInt(build);
	var stage = parseInt(props.match.params.stage || 1);
	var step = parseInt(props.match.params.step || 1);
...
var Output = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
	...
	Output.prototype.componentWillUpdate = function componentWillUpdate(nextProps) {
		...
		if ((0, _proc.assertProcFinished)(nextProps.step)) {
			return this.props.dispatch(_logs.fetchLogs, nextProps.drone, nextProps.match.params.namespace, nextProps.match.params.name, nextProps.build.number, nextProps.stage.number, nextProps.step.number);
		}

		if ((0, _proc.assertProcRunning)(nextProps.step) && (!logs || routeChange)) {
			this.props.dispatch(_logs.subscribeToLogs, nextProps.drone, nextProps.match.params.namespace, nextProps.match.params.name, nextProps.build.number, nextProps.stage.number, nextProps.step.number);
		}
	};
	...
	Output.prototype.render = function render() {
		...
		return _react2["default"].createElement(
			...
			_react2["default"].createElement(_term2["default"], {
				lines: logs || [],
				exitcode: (0, _proc.assertProcFinished)(step) ? step.exit_code : undefined
			}),
			_react2["default"].createElement(_anchor.Bottom, null),
			_react2["default"].createElement(Actions, {
				running: (0, _proc.assertProcRunning)(step),
				following: follow,
...
var assertProcFinished = exports.assertProcFinished = function assertProcFinished(proc) {
	return proc.status !== _status.STATUS_RUNNING && proc.status !== _status.STATUS_PENDING && proc.status !== _status.STATUS_PLANNED;
};
...
var assertProcRunning = exports.assertProcRunning = function assertProcRunning(proc) {
	return proc.status === _status.STATUS_RUNNING;
};
...
function subscribeToLogs(tree, client, namespace, repo, build, stage, step) {
	if (subscribeToLogs.ws) {
		subscribeToLogs.ws.close();
	}
	var slug = (0, _repository.repositorySlug)(namespace, repo);
	var init = { data: [] };

	tree.set(["logs", "data", slug, build, stage, step], init);

	subscribeToLogs.ws = client.stream(namespace, repo, build, stage, step, function (item) {
		tree.push(["logs", "data", slug, build, stage, step, "data"], item);
	});
}

function fetchLogs(tree, client, namespace, repo, build, stage, step) {
	var slug = (0, _repository.repositorySlug)(namespace, repo);
	var init = {
		data: [],
		loading: true
	...
	client.getLogs(namespace, repo, build, stage, step).then(function (results) {
...
var _ansi_up = __webpack_require__(195);

var _ansi_up2 = _interopRequireDefault(_ansi_up);

var _term = __webpack_require__(531);
...
var _anchor = __webpack_require__(534);
...
var BuildMenu = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
	...
	BuildMenu.prototype.handleRestart = function handleRestart() {
		...
		dispatch(_build.restartBuild, drone, repo.namespace, repo.name, build.number);
	};
	...
	BuildMenu.prototype.handleCancel = function handleCancel() {
		...
		dispatch(_build.cancelBuild, drone, repo.namespace, repo.name, build.number);
	};
			...
			!build ? undefined : _react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(
						"li",
						null,
						build.status === "pending" || build.status === "planned" || build.status === "running" ? _react2["default"].createElement(
							"button",
...
var _snackbar = __webpack_require__(542);
...
var _drawer = __webpack_require__(554);
