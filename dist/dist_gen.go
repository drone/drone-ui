...
var files = map[string]file{
	"/favicon.png": {
		...
		FileInfo: &fileInfo{
			name:    "favicon.png",
			size:    1374,
			modTime: time.Unix(1529092073, 0),
		},
	},
	"/index.html": {
		data: file1,
	...
	"/static/bundle.108ef3f14cc7ecfed46c.js": {
		data: file2,
		FileInfo: &fileInfo{
			name:    "bundle.108ef3f14cc7ecfed46c.js",
			size:    349873,
			modTime: time.Unix(1529092073, 0),
		},
	},
	"/static/vendor.7ca7b43058d4219b657a.js": {
		data: file3,
		FileInfo: &fileInfo{
			name:    "vendor.7ca7b43058d4219b657a.js",
			size:    272097,
			modTime: time.Unix(1529092073, 0),
		},
	},
...
<body>
<script type="text/javascript" src="/static/vendor.7ca7b43058d4219b657a.js"></script><script type="text/javascript" src="/static/bundle.108ef3f14cc7ecfed46c.js"></script></body>
</html>
`)
...
var subscribeToFeed = exports.subscribeToFeed = function subscribeToFeed(tree, client) {
	return client.on(function (data) {
		...
		if (tree.exists("feed", "data", repo.slug)) {
			var cursor = tree.select(["feed", "data", repo.slug]);
			cursor.merge(build);
		}
