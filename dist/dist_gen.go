...
var files = map[string]file{
	"/favicon.png": {
		...
		FileInfo: &fileInfo{
			name:    "favicon.png",
			size:    1374,
			modTime: time.Unix(1529301739, 0),
		},
	},
	"/index.html": {
		data: file1,
	...
	"/static/bundle.17a378b2e6c8448e920c.js": {
		data: file2,
		FileInfo: &fileInfo{
			name:    "bundle.17a378b2e6c8448e920c.js",
			size:    348526,
			modTime: time.Unix(1529301739, 0),
		},
	},
	"/static/vendor.7613c72b9962012a1aa1.js": {
		data: file3,
		FileInfo: &fileInfo{
			name:    "vendor.7613c72b9962012a1aa1.js",
			size:    271985,
			modTime: time.Unix(1529301739, 0),
		},
	},
...
<body>
<script type="text/javascript" src="/static/vendor.7613c72b9962012a1aa1.js"></script><script type="text/javascript" src="/static/bundle.17a378b2e6c8448e920c.js"></script></body>
</html>
`)
		...
		return _react2["default"].createElement(
			...
			_react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(
						_reactRouterDom.Link,
						{ to: "/" + namespace + "/" + name + "/settings/registry" },
						"Registry"
					)
				),
				_react2["default"].createElement(
		...
		return _react2["default"].createElement(
			...
			_react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(_reactRouterDom.Route, { path: "/:namespace/:name", exact: true, component: _builds2["default"] }),
					_react2["default"].createElement(_reactRouterDom.Route, { path: "/", exact: true, component: _redirect2["default"] })
				)
			),
			...
			_react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(_reactRouterDom.Route, { path: "/:namespace/:name", exact: false, component: _menu8["default"] })
				),
				_react2["default"].createElement(
					"section",
					null,
...
var RepoRegistry = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
	...
	RepoRegistry.prototype.componentWillMount = function componentWillMount() {
		...
		var _match$params = match.params,
		    namespace = _match$params.namespace,
		    name = _match$params.name;

		dispatch(_registry.fetchRegistryList, drone, namespace, name);
	};
	...
	RepoRegistry.prototype.handleSave = function handleSave(e) {
		...
		var _match$params2 = match.params,
		    namespace = _match$params2.namespace,
		    name = _match$params2.name;
		...
		dispatch(_registry.createRegistry, drone, namespace, name, registry);
	};
	...
	RepoRegistry.prototype.handleDelete = function handleDelete(registry) {
		...
		var _match$params3 = match.params,
		    namespace = _match$params3.namespace,
		    name = _match$params3.name;

		dispatch(_registry.deleteRegistry, drone, namespace, name, registry.address);
	};
 ...
 * @param {string} name - The repository name.
 */
var fetchRegistryList = exports.fetchRegistryList = function fetchRegistryList(tree, client, namespace, name) {
	var slug = (0, _repository.repositorySlug)(namespace, name);

	tree.unset(["registry", "loaded"]);
	tree.unset(["registry", "error"]);

	client.getRegistryList(namespace, name).then(function (results) {
		var list = {};
 ...
 */
var createRegistry = exports.createRegistry = function createRegistry(tree, client, namespace, name, registry) {
	var slug = (0, _repository.repositorySlug)(namespace, name);

	client.createRegistry(namespace, name, registry).then(function (result) {
 ...
 * @param {Object} registry - The registry hostname.
 */
var deleteRegistry = exports.deleteRegistry = function deleteRegistry(tree, client, namespace, name, registry) {
	var slug = (0, _repository.repositorySlug)(namespace, name);

	client.deleteRegistry(namespace, name, registry).then(function (result) {
...
var RepoSecrets = (_dec = (0, _higherOrder.branch)(binding), (0, _inject.inject)(_class = _dec(_class = function (_Component) {
	...
	RepoSecrets.prototype.componentWillMount = function componentWillMount() {
		...
		this.props.dispatch(_secrets.fetchSecretList, this.props.drone, namespace, name);
	};
	...
	RepoSecrets.prototype.handleSave = function handleSave(e) {
		...
		dispatch(_secrets.createSecret, drone, namespace, name, secret);
	};
	...
	RepoSecrets.prototype.handleDelete = function handleDelete(secret) {
		...
		dispatch(_secrets.deleteSecret, drone, namespace, name, secret.name);
	};
 ...
 * @param {string} name - The repository name.
 */
var fetchSecretList = exports.fetchSecretList = function fetchSecretList(tree, client, namespace, name) {
	var slug = (0, _repository.repositorySlug)(namespace, name);

	tree.unset(["secrets", "loaded"]);
	tree.unset(["secrets", "error"]);

	client.getSecretList(namespace, name).then(function (results) {
		var list = {};
 ...
 */
var createSecret = exports.createSecret = function createSecret(tree, client, namespace, name, secret) {
	var slug = (0, _repository.repositorySlug)(namespace, name);

	client.createSecret(namespace, name, secret).then(function (result) {
 ...
 */
var deleteSecret = exports.deleteSecret = function deleteSecret(tree, client, namespace, name, secret) {
	var slug = (0, _repository.repositorySlug)(namespace, name);

	client.deleteSecret(namespace, name, secret).then(function (result) {
...
var Form = exports.Form = function (_Component) {
	...
	function Form(props, context) {
		...
		_this._handlePolicyChange = _this._handlePolicyChange.bind(_this);
		_this._handleSubmit = _this._handleSubmit.bind(_this);
	...
	Form.prototype._handlePolicyChange = function _handlePolicyChange(event) {
	...
	return _react2["default"].createElement(
		...
		_react2["default"].createElement(
			...
			_react2["default"].createElement(
				"ul",
				null,
				props.policy ? Object.keys(props.policy).map(function (key) {
					return renderDirective(key, props.policy[key]);
				}) : null
			)
		),
		_react2["default"].createElement(
...
var renderDirective = function renderDirective(name, directive) {
	if (directive.none) {
		return _react2["default"].createElement(
			"li",
			null,
